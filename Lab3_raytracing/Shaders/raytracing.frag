...
void initializeDefaultLightMaterials(out SLight light, out SMaterial materials[7])
{
    ...
    /** MATERIALS **/
    // Left wall material (sand-yellow)
    materials[0].Color = vec3(0.94, 0.75, 0.0);
    materials[0].LightCoeffs = vec4(lightCoefs);
    materials[0].ReflectionCoef = 0.5;
    materials[0].RefractionCoef = 1;
    materials[0].MaterialType = DIFFUSE; // REFLECTION

    // Front wall material (blue)
    materials[1].Color = vec3(0.0, 0.5, 1.0);
    materials[1].LightCoeffs = vec4(lightCoefs);
    materials[1].ReflectionCoef = 0.2;
    materials[1].RefractionCoef = 1;
    materials[1].MaterialType = DIFFUSE; // REFLECTION

    // Back wall material (purple)
    materials[2].Color = vec3(0.8, 0.0, 1.0);
    ...
    // Ceiling material (pink)
    materials[3].Color = vec3(0.91, 0.61, 0.71);
    ...
    // Floor material (blue-green)
    materials[4].Color = vec3 (0.0, 1.0, 0.9);
    ...
    materials[5].Color = vec3(0.1, 0.1, 0.1);
    ...
    ///Spheres material (prozrazhnoct)
    //materials[6].Color = vec3(0.81, 0.25, 0.13);
...
bool Raytrace(SRay ray, SSphere spheres[2], STriangle triangles[12], SMaterial materials[7],
